...
class LLaMA:
    ...
    def build(checkpoints_dir: str, tokenizer_path: str, load_model: bool, max_seq_len: int, max_batch_size: int, device: str):
        ...
        if load_model:
            ...
            assert len(
                checkpoints) > 0, f"no checkpoint files found in {checkpoints_dir}"
...
if __name__ == "__main__":
    ...
    prompts = [
        ...
        "If Tesla was an indian company founded in Calcutta, it would ",
        # Few shot prompt
        ...
        policeman => """,
        # Zero shot prompt
        """Tell me if the following person is a pokemon disguised as a human:
        Name: Ash Ketchum
        Decision: 
        """
    ]
